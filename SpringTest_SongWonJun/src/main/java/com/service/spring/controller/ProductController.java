...
public class ProductController {
	...
	public String insertProduct(Model model, Product product, RedirectAttributes ra) throws Exception {
		try {
	...
	public String detailProduct(Model model, Product product) throws Exception {
		try {
	...
	public String searchProduct(Model model, String contentKey, String contentValue) throws Exception {
		try {
	...
	/*
	 * @PostMapping("signup.do") public String doSignup(UserInfo user) throws
	 * Exception { try { productService.signup(user); return "redirect:/moveLogin";
	 * } catch (Exception e) { throw new Exception("회원가입 실패(id 중복)"); } }
	 */
